...
public class SelectWindowController implements Initializable {
    ...
    private ObservableList<IStmt> initList()
    {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())), new CompStmt(
                ...
                new CompStmt(new NewStmt("a", new ValueExp(new IntValue(0))), new CompStmt(new NewStmt("b", new ValueExp(new IntValue(0))),
                        new CompStmt(new HeapWriteStmt("a", new ValueExp(new IntValue(1))),
                                new CompStmt(new HeapWriteStmt("b", new ValueExp(new IntValue(2))), new CompStmt(
                                        new CondAssignmentStmt(new RelExp(new HeapReadExp(new VarExp("a")), new HeapReadExp(new VarExp("b")), "<"),
                                                new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200)), "v"), new CompStmt(new PrintStmt(new VarExp("v")),
                                        new CompStmt(new CondAssignmentStmt(new RelExp(new ArithExp(new HeapReadExp(new VarExp("b")), new ValueExp(new IntValue(2)), '-'),
                                                new HeapReadExp(new VarExp("a")), ">"), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200)), "v"),
