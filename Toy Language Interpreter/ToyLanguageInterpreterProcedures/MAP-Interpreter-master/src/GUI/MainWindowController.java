...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Value>, String> procedureBody;

    @FXML
    private TableColumn<Map.Entry<Integer, Value>, String> procedureSignature;

    @FXML
    private TableView<Map.Entry<Integer, Value>> proceduresTableView;
    ...
    public void initSymTableView(PrgState prgState) throws MyException {
        symbolTableView.setItems(FXCollections.observableList(new ArrayList<>(prgState.getTopOfSymStack().getContent().entrySet())));
        symbolTableView.refresh();
    }

    public void update(PrgState prgState) throws MyException {
        if(prgState == null)
            return;
        initNoProgStates();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        progIdView.setOnMouseClicked(e -> {
            try {
                update(getSelectedProgramState());
