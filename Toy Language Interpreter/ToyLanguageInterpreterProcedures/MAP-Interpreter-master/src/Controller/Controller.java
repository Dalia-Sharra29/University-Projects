...
public class Controller {
    ...
    public void callGarbageCollector(List<PrgState> prgStateList)
    {
        prgStateList.forEach(prgState -> {
            try {
                prgState.getHeapTable().setContent(safeGarbageCollector(getAddressFromSymTable(
                        prgState.getTopOfSymStack().getContent().values(), prgState.getHeapTable().getContent().values()),
