...
public class SelectWindowController implements Initializable {
    ...
    private ObservableList<IStmt> initList()
    {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(2))), new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(3))),
                                new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))), new CompStmt(new NewLatchStmt("cnt", new HeapReadExp(new VarExp("v2"))),
                                        new CompStmt(new ForkStmt(new CompStmt(new HeapWriteStmt("v1",
                                                new ArithExp(new HeapReadExp(new VarExp("v1")), new ValueExp(new IntValue(10)), '*')),
                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v1"))), new CompStmt(new CountDownStmt("cnt"),
                                                        new ForkStmt(new CompStmt(new HeapWriteStmt("v2",
                                                                new ArithExp(new HeapReadExp(new VarExp("v2")), new ValueExp(new IntValue(10)), '*')),
                                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v2"))), new CompStmt(new CountDownStmt("cnt"),
                                                                        new ForkStmt(new CompStmt(new HeapWriteStmt("v3",
                                                                                new ArithExp(new HeapReadExp(new VarExp("v3")), new ValueExp(new IntValue(10)), '*')),
                                                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v3"))), new CountDownStmt("cnt")))))))))))),
                                                new CompStmt(new AwaitStmt("cnt"), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))), new CompStmt(new CountDownStmt("cnt"),
