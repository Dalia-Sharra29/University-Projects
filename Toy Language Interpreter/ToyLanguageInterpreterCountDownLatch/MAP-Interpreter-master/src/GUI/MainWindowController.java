...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchValue;

    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchLocation;
    ...
    public void initLatchTableView(PrgState prgState)
    {
        latchTableView.setItems(FXCollections.observableList(new ArrayList<>(prgState.getLatchTable().getContent().entrySet())));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        latchLocation.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getKey() + " "));
        latchValue.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue() + " "));
