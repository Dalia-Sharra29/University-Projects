...
public class Interpreter {
    ...
    public static void main(String[] args) {
        ...
        PrgState prog1 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex1);
        ...
        PrgState prog2 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex2);
        ...
        PrgState prog3 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex3);
        ...
        PrgState prog4 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex4);
        ...
        PrgState prog5 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex5);
        ...
        PrgState prog6 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex6);
        ...
        PrgState prog7 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex7);
        ...
        PrgState prog8 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLatchTable<>(), ex8);
