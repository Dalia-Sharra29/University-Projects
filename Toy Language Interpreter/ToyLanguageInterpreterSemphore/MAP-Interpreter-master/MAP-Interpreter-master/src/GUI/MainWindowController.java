...
public class MainWindowController implements Initializable {
    ...
    private void initSemaphoreTableView(PrgState prgState)
    {
        semaphoreTableView.setItems(FXCollections.observableList(new ArrayList<>(prgState.getSemaphoreTable().getContent().entrySet())));
    ...
    public void update(PrgState prgState)
    {
        ...
        initSemaphoreTableView(prgState);
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        semaphoreIndexColumn.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getKey() + " "));
        semaphoreValueColumn.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getKey() + " "));
        semaphoreListColumn.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getValue() + " "));
