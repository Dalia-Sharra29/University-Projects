...
public class SelectWindowController implements Initializable {
    ...
    private ObservableList<IStmt> initList()
    {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(
                new VarDeclStmt("cnt", new IntType()), new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(1))),
                new CompStmt(new CreateSemaphoreStmt("cnt", new HeapReadExp(new VarExp("v1"))), new CompStmt(
                        new ForkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new HeapWriteStmt("v1",
                        ...
                        new CompStmt(new ForkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new HeapWriteStmt("v1",
                                new ArithExp(new HeapReadExp(new VarExp("v1")), new ValueExp(new IntValue(10)), '*')),
                                new CompStmt(new HeapWriteStmt("v1", new ArithExp(new HeapReadExp(new VarExp("v1")),
            new ValueExp(new IntValue(2)), '*')), new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v1"))), new ReleaseStmt("cnt")))))),
                                new CompStmt(new AcquireStmt("cnt"), new CompStmt(new PrintStmt(new ArithExp(
                                        new HeapReadExp(new VarExp("v1")), new ValueExp(new IntValue(1)), '-')), new ReleaseStmt("cnt")))))))));
