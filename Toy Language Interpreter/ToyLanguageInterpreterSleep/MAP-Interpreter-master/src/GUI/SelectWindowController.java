...
public class SelectWindowController implements Initializable {
    ...
    private ObservableList<IStmt> initList()
    {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(10))),
                new CompStmt(new ForkStmt(new CompStmt(new AssignStmt("v", new ArithExp(new VarExp("v"),
                        new ValueExp(new IntValue(1)), '-')), new CompStmt(new AssignStmt("v",
                        new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), '-')), new PrintStmt(new VarExp("v"))))),
                        new CompStmt(new SleepStmt(10), new PrintStmt(new ArithExp(new VarExp("v"), new ValueExp(new IntValue(10)), '*'))))));

        IStmt ex10 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(0))), new CompStmt(
                new WhileStmt(new RelExp(new VarExp("v"), new ValueExp(new IntValue(3)), "<"), new CompStmt(new ForkStmt(new CompStmt(new PrintStmt(new VarExp("v")),
